...
class M3U8:
  ...
  def manifest(self, skip: bool = False) -> str:
    m3u8 = ''
    m3u8 += f'#EXTM3U\n'
    # Always advertise protocol version 9 so LL-HLS tags (#EXT-X-PART, PRELOAD-HINT, SERVER-CONTROL)
    # are honored by clients; lower versions can cause players to ignore partials and fall back.
