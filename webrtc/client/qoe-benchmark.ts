 ...
 *
 * Simulates multiple concurrent clients watching the same WebRTC stream
 * and collects QoE metrics: Latency, Time to First Frame (TTFF), and Stalls.
 *
 * Usage:
 *   npx tsx webrtc/client/qoe-benchmark.ts --clients 10 --duration 60 --page http://localhost:8080/
 */
...
import { generateReports } from "../../ll-hls/client/qoe-reporter.js";
import { ClientMetrics } from "../../ll-hls/client/qoe-types.js";
