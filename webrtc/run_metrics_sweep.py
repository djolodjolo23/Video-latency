...
CONNECT_RE = re.compile(r"Socket connected ([A-Za-z0-9_-]+)")
DISCONNECT_RE = re.compile(r"Socket disconnected ([A-Za-z0-9_-]+)")
...
def main() -> None:
    ...
    parser.add_argument("--start", type=int, default=14, help="Starting expected client count")
